          ...
          >
            ...
            <div className="md:p-3 space-y-2 md:space-y-4 text-justify">
              ...
              <p className="text-lg md:text-2xl">
                ...
                properties. The platform retrieves guest check-in and check-out
                details, generates a time-based smart lock code using Tuya IoT,
                and automatically sends the code via email to the guest.
              </p>
